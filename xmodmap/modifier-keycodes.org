...
* Testing changes using =xmodmap=

I dumped the current xmodmap configuration
$ xmodmap -pke > ~/.Xmodmap

To test the changes:
$ xmodmap ~/.Xmodmap

Modifying file:~/.Xmodmap I successfully exchanged O and P as follows:

#+begin_src
keycode  33 = o O o O oe OE oe
keycode  32 = p P p P thorn THORN thorn
#+end_src
...
* See ~/.xmodmap AT THE END

There I made some experiments. I was able to get opt_L to switch between the apps.
However, cmd_L did not get the Meta-Function but some weired C-M- or something like that.
I believe some other level of key translations inteferes



* General keycodes

** Keycode list via xmodmap (complete)

#+begin_src
$ xmodmap -pke
keycode   8 =
keycode   9 = Escape NoSymbol Escape
keycode  10 = 1 plus 1 plus bar exclamdown bar
keycode  11 = 2 quotedbl 2 quotedbl at oneeighth at
keycode  12 = 3 asterisk 3 asterisk numbersign sterling numbersign
keycode  13 = 4 ccedilla 4 ccedilla onequarter dollar onequarter
...
keycode  16 = 7 slash 7 slash bar seveneighths bar
keycode  17 = 8 parenleft 8 parenleft cent trademark cent
...
keycode  20 = apostrophe question apostrophe question dead_acute questiondown dead_acute
keycode  21 = dead_circumflex dead_grave dead_circumflex dead_grave dead_tilde dead_ogonek dead_tilde
keycode  22 = BackSpace BackSpace BackSpace BackSpace
keycode  23 = Tab ISO_Left_Tab Tab ISO_Left_Tab
keycode  24 = q Q q Q at Greek_OMEGA at
keycode  25 = w W w W U017F section U017F
keycode  26 = e E e E EuroSign E EuroSign
...
keycode  34 = udiaeresis egrave udiaeresis egrave bracketleft dead_abovering bracketleft
...
keycode  47 = odiaeresis eacute odiaeresis eacute dead_acute dead_doubleacute dead_acute
keycode  48 = adiaeresis agrave adiaeresis agrave braceleft dead_caron braceleft
keycode  49 = section degree section degree notsign notsign notsign
keycode  50 = Shift_L NoSymbol Shift_L
keycode  51 = dollar sterling dollar sterling braceright dead_breve braceright
keycode  52 = y Y y Y guillemetleft less guillemetleft
keycode  53 = x X x X guillemetright greater guillemetright
...
keycode  58 = m M m M mu ordmasculine mu
keycode  59 = comma semicolon comma semicolon U2022 multiply U2022
...
keycode  93 =
keycode  94 = less greater less greater backslash brokenbar backslash
...
** Keycode list via xmodmap (filtered)

1) xmodmap -pke | grep "_" | grep -v KP | grep -v "_VT_"
2) manually removed irrelevant lines
